          ...
          <ul className="text-slate-700 dark:text-slate-100">
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                ...
                <label htmlFor="price-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Precio - Mayor a Menor</label>
              </div>
              <div className="flex items-center my-1">
                ...
                <label htmlFor="price-sort-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Precio - Menor a Mayor</label>
              </div>
            </li>
            <li className="mt-1 mb-5">
              <span className="font-semibold">Valoracion</span>
              <div className="flex items-center my-1">
                ...
                <label htmlFor="rating-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">4 Estrellas o Mas</label>
              </div>
              <div className="flex items-center my-1">
                ...
                <label htmlFor="rating-sort-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">3 Estrellas o Mas</label>
              </div>
              <div className="flex items-center my-1">
                ...
                <label htmlFor="rating-sort-3" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">2 Estrellas o Mas</label>
              </div>
              <div className="flex items-center my-1">
                ...
                <label htmlFor="rating-sort-4" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">1 Estrellas o Mas</label>
              </div>
            </li>
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                ...
                <label htmlFor="best-seller" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Solo Los Mas Vendidos</label>
              </div>
              <div className="flex items-center my-1">
